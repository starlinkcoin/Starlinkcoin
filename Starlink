...
contract StarlinkCoin is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public tokensForRewards = 100000000000 * 10**9;

    uint256 public _maxTxAmount = 500000000 * 10**9;

    uint256 public lpNum =5;
    uint256 public numTokensSellToAddToLiquidity = tokensForRewards.mul(lpNum).div(10000);
    //uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**9; 
    ...
    bool public swapBuyLiquifyEnabled = false;
    bool public swapSellLiquifyEnabled = false;
    ...
    constructor() ERC20("Starlink Coin", "Starlink") {
        addressForMarketing =_msgSender();
        mintContract=address(this);

        _mint(_msgSender(), tokensForRewards);
